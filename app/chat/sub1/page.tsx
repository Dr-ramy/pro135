        ...
        <CardContent className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
            ...
            <div className="text-gray-700 leading-relaxed text-right border rounded-md p-3 bg-muted max-h-48 overflow-y-auto">
              <p>الفقرة 1: هذا نص تجريبي لتوضيح مكان الفقرات بجانب الصورة.</p>
              <p>الفقرة 2: يمكنك وضع هنا أي نصوص تعليمية أو توجيهات.</p>
              <p>الفقرة 3: الهدف هو عرض النص بشكل منسق وواضح.</p>
              <p>الفقرة 4: يمكن تعديل هذا النص حسب الحاجة.</p>
              <p>الفقرة 5: الشات بالأسفل لتلقي الإجابات من المستخدم.</p>
              <p>الفقرة 6: كل فقرة يمكن أن تكون جملة أو أكثر.</p>
              <p>الفقرة 7: يمكنك تنسيقها بأي طريقة تناسب المحتوى.</p>
            </div>
