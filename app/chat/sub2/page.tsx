        ...
        <CardContent className="p-4">
          ...
          />
            ...
            <div className="text-gray-700 leading-relaxed text-right border rounded-md p-3 bg-muted max-h-48 overflow-y-auto">
              <p>سنكتشف اليوم معًا تضاريس عالمنا العربي، ونعرف ما يميزه من جبال وهضاب وسهول وصحاري.
وضح لهم أن تضاريس العالم العربي متنوعة بين الجبال والهضاب و السهول والصحاري والأودية الجافة والأحواض.
فهناك المنخفضات الي تصل الي 400م تحت مستوي سطح البحر كما في البحر الميت في الأردن وفلسطين، وهناك مرتفعات ترتفع الي 4000م فوق مستوي سطح البحر مثل سلاسل حبال أطلس في المغرب العربي.
.</p>
            </div>
