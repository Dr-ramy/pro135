...
export default function ChatPage() {
  ...
  <p>ما أهم العوامل المؤثرة في مناخ العالم العربي؟</p>
  <p>كيف يؤثر الموقع الفلكي في مناخ العالم العربي؟</p>
  <p>كيف يؤثر الغطاء النباتي في مناخ العالم العربي؟</p>
  <p>كيف يؤثر الموقع الجغرافي في مناخ العالم العربي؟</p>
  <p>كيف تؤثر التضاريس الأرضية في مناخ العالم العربي؟</p>
            </div>
